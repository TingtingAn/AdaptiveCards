        ...
        public ResourceDictionary Resources
        {
            get
            {
                ...
                try
                {
                    ...
                    {
                        Source = new Uri("/AdaptiveCards.Rendering.XamarinForms;component/Themes/generic.xaml",
            ...
            set
            {
                ...
                try
                {
                    var resource = new ResourceDictionary
                    {
                        Source = new Uri("/AdaptiveCards.Rendering.XamarinForms;component/Themes/generic.xaml", UriKind.RelativeOrAbsolute)
                    };
                    _resources.MergedDictionaries.Add(resource);
                }
                catch { }
